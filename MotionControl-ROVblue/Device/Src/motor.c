...
void MotorPwmRefresh(float *motorthrust)
{
    ...
    __HAL_TIM_SetCompare(&htim4, TIM_CHANNEL_2, pwmoutput[0]);
    __HAL_TIM_SetCompare(&htim5, TIM_CHANNEL_3, pwmoutput[1]);
    __HAL_TIM_SetCompare(&htim4, TIM_CHANNEL_1, 2 * Motor_Pwm_Median_Duty - pwmoutput[2]);
    __HAL_TIM_SetCompare(&htim5, TIM_CHANNEL_2, 2 * Motor_Pwm_Median_Duty - pwmoutput[3]);
    __HAL_TIM_SetCompare(&htim5, TIM_CHANNEL_1, pwmoutput[4]);
    __HAL_TIM_SetCompare(&htim5, TIM_CHANNEL_4, 2 * Motor_Pwm_Median_Duty - pwmoutput[5]);
}
