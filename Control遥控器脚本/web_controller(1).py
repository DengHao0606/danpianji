        ...
        for i in range(joystick_count):
            ...
            if monitor.mode == 0:
                ...
                if joystick_axis[1]**2 + joystick_axis[2]**2 >= 0.03 ** 2 :
                    monitor.controller["y"] = -2500.0 * controller_curve(joystick_axis[1])  # 前后
                    monitor.controller["x"] = 5000.0 * controller_curve(joystick_axis[2])  # 左右
                else :
                ...
                if(joystick.get_axis(5) != -1):
                    ...
                    monitor.controller["servo0"] = 0.2# 舵机
                ...
                if(joystick.get_axis(4) != -1):
                    monitor.controller["servo0"] = 0.5
                elif(joystick.get_button(9)):
                   # monitor.controller["servo0"] = 0.475
                    monitor.controller["servo0"] = 0.5

                elif(joystick.get_button(10)):
                    monitor.controller["servo0"] = 0.2
